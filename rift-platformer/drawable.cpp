...
Drawable::Drawable(const char* imageName, int width, int height)
{
	this->load(imageName, width, height);
}

void Drawable::Flip(bool flipH, bool flipV)
{
...
void Drawable::load(const char* imageName, int width, int height)
{
...
void Drawable::Draw(sf::RenderTexture* window)
{
